...
export class GettingStartedPage extends EditorPane {
	...
	private async buildCategoriesSlide(preserveFocus?: boolean) {
		...
		const header = $('.header', {},
			$('h1.product-name.caption', {}, "Welcome to OMNI-IDE"),
			$('p.subtitle.description', {}, "Build faster with OMNI-IDE and AI agents"),
			$('p.author.description', {}, "Created by Nihan Nihu (Mohammed Nihan)")
		);
